...
EXEC_ID = None  # referência global
...
def main(exec_id=None, contas=None):
    """
    Função principal do pipeline.
    exec_id e contas podem ser passados para testes.
    """
    global driver, EXEC_ID
    EXEC_ID = exec_id or datetime.now().strftime("%Y%m%d_%H%M%S")
    ...
    if driver is None:
        # 🚨 Apenas cria driver real se não estiver mockado
    ...
    try:
        ...
        CONTAS = contas or carregar_contas_do_glossario()
